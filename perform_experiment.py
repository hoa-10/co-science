...
dataset = 'pect_ndt_full_dataset.npz'
MAX_ITERS = 6
MAX_RUNS = 5
...
###requirment:
you need to load dataset with path : data_path = 'pect_ndt_full_dataset.npz'
Instructions:
Propose Experiments:
...
Important:
you dont need note because the generated code quite long and complex
...
def run_experiment(folder_name, run_num, timeout=3600):  # Reduced timeout
    ...
    try:
        ...
        if os.path.exists(dataset):
            shutil.copy(dataset, folder_name)
    except Exception as e:
